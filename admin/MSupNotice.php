...
<!-- 导航部分结束 -->
    <table class="layui-hide" id="supNotice" lay-filter="supNotice" ></table>
...
layui.use('table', function(){
  ...
  table.render({
    ...
    ,cols: [[
      ...
      ,{field:'noticeID', title:'通知ID', width:100, fixed: 'left', unresize: true, sort: true}
      ,{field:'className', title:'课程名字',  edit: 'text'}
      ,{field:'classid', title:'课程id',  edit: 'text'}
      ,{field:'NoticeTitle', title:'Title', width:200, edit: 'text'}
      ,{field:'info', title:'主体', width:200, edit: 'text'}
      ,{field:'uptime', title:'上传时间', width:100, edit: 'text'}
      ,{field:'updateName', title:'创建者', width:80, edit: 'text'}
  ...
  //头工具栏事件
  table.on('toolbar(supNotice)', function(obj){
  ...
  //监听行工具事件
  table.on('tool(supNotice)', function(obj){
    var data = obj.data;
    //console.log(obj)
    if(obj.event === 'del'){
