...
<script>window.onload = function(){ AsyscGetMenu(); AsyscNotice('./stu/ajax/ajaxteaShowNotice.php'); };  function backTeaCheckClass(){window.location.href="./stu/teaCheckClass.php";}</script>
</body>
</html>
