        ...
        <form action="./location/teaAddNoticelocation.php" method="POST">
            <fieldset>
                ...
                <div class="col col-6">
                    ...
                    <div class="col col-6">
                        <div class="field-group prepend-icon">
                            <label class="mdn-label" style="color:red;"><?php $Note=isset($_GET["Note"])?$_GET["Note"]:"";switch($Note) {case 1:echo "提交成功!";break;case 2:echo "公告信息不能为空!";break;case 3:echo "提交失败!数据库连接错误,请检查您的网络!";break;}?></label>
                            <span class="mdn-bar"></span>
                        </div>  
                    </div><!-- end col-6 -->
                </div><!-- end form-row -->
...
<script>window.onload = function(){ AsyscGetMenu(); AsyscNotice('http://data.twogether.cn/ChooseClass/stu/ajax/ajaxteaShowNotice.php'); };  function backTeaCheckClass(){window.location.href="http://data.twogether.cn/ChooseClass/stu/teaCheckClass.php";}</script>
</body>
</html>
