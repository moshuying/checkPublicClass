...
<script>window.onload = function(){AsyscClassCard('http://data.twogether.cn/ChooseClass/stu/ajax/ajaxShowAllClass.php'); AsyscNotice('http://data.twogether.cn/ChooseClass/stu/ajax/ajaxteaShowNotice.php');  } </script>
</body>
</html>
