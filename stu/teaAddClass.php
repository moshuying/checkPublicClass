...
<!-- 添加信息 -->
<form action="./location/teaAddClasslocation.php" method="post" enctype="multipart/form-data" >
...
<script>
window.onload = function(){/*AsyscGetMenu();*/ AsyscNotice('./stu/ajax/ajaxteaShowNotice.php');}
$(document).ready(function(){$('#imgHeadPhoto').click(function(){$('#jumpCLICK').click();});$('#imgHeadPhoto2').click(function(){$('#jumpCLICK').click();});});
function backTeaCheckClass(){window.location.href="./stu/teaCheckClass.php";}
</script>
</body>
</html>
