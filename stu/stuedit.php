    ...
    <div class="modern-container">
        <form action="./location/stueditlocation.php" method="POST">
            ...
            <div class="mdn-footer">
                ...
                <button type="sublim" onclick="stuSublimBefore()"; class="mdn-button btn-primary btn-raised">提交您的信息</button>
            </div>
        </form>    
...
<script src="../public/js/ajaxstuedit.js"></script>
<script src="../public/js/publicJs/ajaxAsysc.js"></script>
<script>window.onload = function(){ AsyscNotice('./stu/ajax/ajaxteaShowNotice.php'); /*beforeEDIT('./stu/ajax/ajaxBeforeEDIT.php');*/ } </script>
</body>
</html>
