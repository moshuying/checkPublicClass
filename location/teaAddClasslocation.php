...
try {
            ...
            if(file_exists($filename)){//检查文件或目录是否存在
                ...
                if(move_uploaded_file($_FILES["file"]["tmp_name"],$filename)){//将临时地址移动到指定地址    
                    ...
                    if(empty($title)||empty($author)||empty($miaoshu)||empty($neirong1)||empty($preparation)){
                        header("Location:../admin/teaAddClass.php?submit2=2");
                    }else{
                        ...
                        header("Location:../admin/teaAddClass.php?submit2=1");
                    }
                }else{ 
                    header("Location:../admin/teaAddClass.php??submit2=4"); 
                }
            }
        }else{
            header("Location:../admin/teaAddClass.php?submit2=4");
    ...
    header("Location:../admin/teaAddClass.php?submit2=3");
